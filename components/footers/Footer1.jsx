            ...
            <div className="col-12">
              <div className="box-list-footer">
                ...
                <div className="box-list box-contact-3">
                  <div className="title-footer text-color-white">A Priority Care</div>
                  <ul className="one-half first mt-5">
                    <li className="text-color-white">
                      "At A Priority Care, we provide compassionate in-home care for seniors, injured individuals, and anyone needing assistance with daily life. Our mission is to make life safer and easier for you and your loved ones." <br />
                      — Krys Shane
                    </li>
                  </ul>
                </div>
                ...
                <div className="box-list box-contact">
                  <div className="title-footer text-color-white">Contact Us</div>
                  <ul className="one-half first">
                    ...
                    <li>
                      ...
                      <span className="ml-2"><a href="tel:9514129091">(951) 412-9091</a></span>
                    </li>
                    <li>
                      <span><i className="fas fa-envelope" /></span>
                      <span className="ml-2"><a href="mailto:careteam@aprioritycare.com">careteam@aprioritycare.com</a></span>
                    </li>
                    <li>
                      <span><i className="fas fa-map-marker-alt" /></span>
                      <span className="ml-2">41877 Enterprise Cir N Suite 200, Temecula, CA 92590</span>
                    </li>
                  </ul>
                </div>
